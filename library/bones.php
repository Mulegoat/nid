...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_enqueue_script( 'jquery-mm' );
    wp_enqueue_script( 'jquery-scrollpane' );
    wp_enqueue_script( 'jquery-mousewheel' );
    wp_enqueue_script( 'jquery-isotope' );
    wp_enqueue_script( 'jquery-fluidvids' );
    wp_enqueue_script( 'jquery-loadImages' );
    wp_enqueue_script( 'jquery-easing' );
    wp_enqueue_script( 'gsap-tweenmax' );
    wp_enqueue_script( 'gsap-scrollto' );
    wp_enqueue_script( 'gsap-jquery' );
...
return '...  <a class="excerpt-read-more icon-right" href="'. get_permalink($post->ID) . '" title="'. __( 'Read', 'bonestheme' ) . get_the_title($post->ID).'">'. __( '', 'bonestheme' ) .'</a>';
}
...
// Uploading SVG to Media Library
